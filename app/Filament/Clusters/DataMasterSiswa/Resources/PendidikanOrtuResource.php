...
use App\Filament\Clusters\DataMasterSiswa\Resources\PendidikanOrtuResource\Pages;
use App\Filament\Clusters\DataMasterSiswa\Resources\PendidikanOrtuResource\RelationManagers;
...
class PendidikanOrtuResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ManagePendidikanOrtus::route('/'),
        ];
    }
}
